...
def continue_sequence(sequence: list) -> list:
  ...
  new_sequence = [new_sequence[0] - differences_continued[0]] + new_sequence + [new_sequence[-1] + differences_continued[-1]]
...
print(f"The sum of all next steps in each sequence is {sum([sequence[0] for sequence in continued_sequences])}")