...
spring_permutations = [get_spring_permuation(values[0]) for values in spring_values]
valid_permutations = [[permutation for permutation in spring_permutations[i] if evaluate_configuration(permutation, spring_values[i][1])] for i in range(len(spring_values))]
