...
intended_unused = 30000000
current_unused = max_storage - size_map["['/']"]
to_clear = intended_unused - current_unused
print(f"The smallest folder size to delete is {min([value for value in size_map.values() if value > to_clear])}")